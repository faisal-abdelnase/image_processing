...
def histogramEqualizationAlg(image_path):
    image = Image.open(image_path)
    img = HistogramEqualization().histogram_equalization(image)
    filename = "histograme_qualization.png"
    img_path = os.path.join(TEMP_IMAGE_DIR, filename)
    img.save(img_path)
    return filename
...
def histogramAlg(image_path):
    image = Image.open(image_path)
    img = Histogram().calculate_histogram(image)
...
functions = {
    ...
    'button2': highPassAlgo,
    'button3': histogramEqualizationAlg,
    'button4': sobelAlg,
    'button5': prewittAlg,
    'button6': kirschAlg,
    'button7': homogeneityAlg,
    'button8': differenceAlg,
    'button9': differenceGaussianAlg,
    'button10': contrastAlgo,
    'button11': varianceAlgo,
    'button12': rangeAlgo,
    'button13': highPassAlgo,
    'button14': lowPassAlgo,
    'button15': medianFilterAlgo,
    'button16': addAlgo,
    'button17': subtractAlgo,
    'button18': invertAlgo,
    'button19': manualSegmentationAlgo,
    'button20': histogramPeakAlgo,
    'button21': histogramValleyAlgo,
    'button22': adaptivehHistogramAlgo,
}
